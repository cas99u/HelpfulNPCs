    ...
    public class HunterNPC : ModNPC
    {
        ...
        public override List<string> SetNPCNameList()
        {
            return new List<string>()
                { 
                  Language.GetTextValue("Mods.HelpfulNPCs.NPCNames.HunterNPC.Name1")
            };
        }
        ...
        public override void AddShops()
        {
            ...
            var dropsShop = new NPCShop(Type, "Drops")
                ...
                .Add(ItemID.Stinger, tierThreeCondition)
                .Add(ItemID.Vine, tierThreeCondition)
            ...
            var ammoShop = new NPCShop(Type, "Ammo")
                ...
                .Add(ItemID.ShimmerArrow, Condition.DownedEyeOfCthulhu)
